...
describe('Data utilities', () => {
   ...
   */
  describe('isPositive()', () => {
    let isPositive = Utils.isPositive;
   ...
   */
  describe('isNegative()', () => {
    let isNegative = Utils.isNegative;
